...
class _ChatboxScreenState extends State<ChatboxScreen> {
  ...
  void initState() {
    ...
    controller.seedLatestMessageFromContact(widget.contact);
                    ...
                    : Container(
                        ...
                        child: const Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                'Jendela 24 jam sudah tertutup. Silakan kirim pesan template dari web panel atau minta pelanggan mengirim pesan (misal: "Hai") untuk mengaktifkan chat kembali.',
                                style: TextStyle(
                                  color: Colors.orange,
                                  fontSize: 12,
                                  fontWeight: FontWeight.w600,
      ...
      child: Obx(() => TextField(
            ...
            decoration: InputDecoration(
              ...
              hintText: controller.isWindowOpened.value
                  ...
                  : 'Kirim pesan (Jendela 24 jam tertutup)...',
