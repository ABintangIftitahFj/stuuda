...
class InputSecurity {
  ...
  String encryptPassword(String plaintext,String publicKey) {
    try {
      // Ensure consistent encryption for same input
      final pem = publicKey;
      final public = CryptoUtils.rsaPublicKeyFromPem(pem);
      ...
      dd('Password encryption failed: $e');
  ...
  String text(String text) {
    try {
      return encryptPassword(text,publickey);
    } catch (e) {
      dd(e);
      return '';
    }
