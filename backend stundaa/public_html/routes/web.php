...
Route::middleware([
    ...
    Route::middleware([
        ...
        ->group(function () {
            ...
            // Files and media view
            Route::get('/files-media', [
                MediaController::class,
                'getMediaAndFileView'
            ])->name('media.files.read_view');

            // Files and media datatable list
            Route::get('/{vendorUid}/{mediaType}/files-media-datatable', [
                MediaController::class,
                'getMediaAndFileDataTableList'
            ])->name('media.files.datatable_list');

            // Delete Files and Media
            Route::post('/delete-files-media', [
                MediaController::class,
                'deleteMediaAndFile'
            ])->name('media.files.write.delete');

            // Delete bulk Files and Media
            Route::post('/delete-bulk-files-media', [
                MediaController::class,
                'deleteBulkMediaAndFile'
            ])->name('media.files.write.bulk_delete');
            ...
            Route::prefix('/manual-subscriptions')->group(function () {
                ...
                Route::get("/list-data/{vendorUid?}/{isAutoRecurring?}", [
                    ManualSubscriptionController::class,
            ...
            Route::group([
                ...
                // optimize table
                Route::post('/operations/optimize-table', [
                    ConfigurationController::class,
                    'optimizeTable',
                ])->name('manage.operations.optimize_table.write');
            ...
            Route::prefix('/vendors')->group(function () {
                ...
                Route::get('/{vendorIdOrUid}/details', [
                    DashboardController::class,
                    'getVendorQuickViewData',
                ])->name('vendor.quick_view_details');
            });
    ...
    Route::middleware([
        ...
        ->group(function () {
            ...
            // Get Ping pong dummy response
            Route::get('/ping-pong', [
                HomeController::class,
                'pingPong',
            ])->name('vendor.ping_pong.read');
            ...
            Route::prefix('/whatsapp')->group(function () {
                ...
                Route::post('/enable-template-analytics', [
                    WhatsAppServiceController::class,
                    'enableTemplateAnalytics',
                ])->name('vendor.whatsapp.enable_template_analytics');
                ...
                Route::prefix('/campaign')->group(function () {
                    ...
                    Route::post('/targeted-contact-count', [
                        WhatsAppServiceController::class,
                        'getTargetedContactCount',
                    ])->name('vendor.campaign.read.targeted_contact_count');
                    ...
                    Route::get('/non-template/{status}/list-data', [
                        CampaignController::class,
                        'prepareNonTemplateCampaignList',
                    ])->name('vendor.campaign.read.non_template_list');

                    Route::get('/non-template-message-presets/{status}/list-data', [
                        CampaignController::class,
                        'nonTemplateCampaignMessagePresetsList',
                    ])->name('vendor.campaign.read.non_template_message_preset_list');
                    ...
                    // Campaign abort process
                    Route::post('/{campaignIdOrUid}/abort-process', [
                      CampaignController::class,
                      'processCampaignAbort',
                    ])->name('vendor.campaign.write.abort');
                ...
                Route::get('/preset-messages-non-template', [
                    ...
                    ])->name('vendor.campaign.read.non_template_list_view');
                ...
                Route::prefix('/templates')->group(function () {
                    ...
                    Route::get('/analytics/{templateUid}', [
                        WhatsAppTemplateController::class,
                        'getTemplatesAnalytics',
                    ])->name('vendor.whatsapp_service.templates.read.analytics');

                    Route::post('/analytics', [
                        WhatsAppTemplateController::class,
                        'processTemplatesAnalytics',
                    ])->name('vendor.whatsapp_service.templates.write.analytics');
                });
            }); 
